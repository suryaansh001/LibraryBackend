...
function isOccupancyBroadcastData(data) {
...
export const occupancyWebsocketPlugin = async (fastify) => {
    ...
    fastify.register(async (fastify) => {
        fastify.get('/ws/occupancy', { websocket: true }, async (connection, request) => {
            ...
            const client = { ws, libraryId, userRole };
...
//# sourceMappingURL=occupancy.websocket.js.map