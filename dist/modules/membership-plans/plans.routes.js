...
import { createPlanBodySchema, updatePlanBodySchema, togglePlanBodySchema, planListQuerySchema, planIdParamSchema } from './plans.schema.js';
...
export const planRoutes = async (fastify) => {
