...
import { createSeatBodySchema, updateSeatBodySchema, updateSeatStatusBodySchema, assignSeatBodySchema, seatListQuerySchema, seatIdParamSchema } from './seats.schema.js';
import { sendSuccess } from '../../shared/utils/response.util.js';
import { buildPaginationMeta } from '../../shared/utils/pagination.util.js';
import { db } from '../../config/database.js';
export const seatsRoutes = async (fastify) => {
