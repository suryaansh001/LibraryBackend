...
import { toDashboardResponseDTO, type DashboardResponseDTO } from '../../shared/dto/dashboard.dto.js';
import { DashboardRepository, DashboardRepositoryImpl } from './dashboard.repository.js';
...
export class DashboardServiceImpl implements DashboardService {
  ...
  public async getDashboard(libraryId: string, requestId: string): Promise<DashboardResponseDTO> {
    ...
    const [
      currentOccupancyResult, capacityResult, todayCheckinsResult, monthlyRevenueResult,
      pendingFeesResult, activeStudentsResult, revenue30dResult, attendance30dResult, recentActivityResult
    ] = results;
