...
import { signAccessToken, verifyAccessToken } from '../../shared/utils/jwt.util.js';

function getRefreshCookiePath(): string {
  return `/api/${config.API_VERSION}/auth`;
}

function setRefreshTokenCookie(reply: import('fastify').FastifyReply, token: string): void {
...
function clearRefreshTokenCookie(reply: import('fastify').FastifyReply): void {
